...
from members.views import search_view
from members.views import toggle_follow
from members.views import tu_truyen_view
from members.views import unfollow_truyen
urlpatterns = [
    ...
    path('toggle_follow/<str:truyen_id>/', toggle_follow, name='toggle_follow'),
    path('tu_truyen/', tu_truyen_view, name='tu_truyen'),
path('unfollow_truyen/<int:truyen_id>/', unfollow_truyen, name='unfollow_truyen')
]
